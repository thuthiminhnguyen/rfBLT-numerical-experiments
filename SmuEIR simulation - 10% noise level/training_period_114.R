...
m114_pred_bayes_lasso_taken = bayes_lasso_taken_y_pred
m114_lowerCI_bayes_lasso_taken = bayes_lasso_taken_lowerCI
m114_upperCI_bayes_lasso_taken = bayes_lasso_taken_upperCI
...
save(I_noise_avg_mat,
     ...
     m114_pred_bayes_lasso_taken,
     m114_lowerCI_bayes_lasso_taken,
     m114_upperCI_bayes_lasso_taken,
