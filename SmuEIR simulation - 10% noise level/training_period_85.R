...
# --- RF, rfBLT with and without smoothness derivatives ---
fixed_point = 85 
...
# Save results for RF
## ESS plots
pdf("train85_RF_ess.pdf", width=7, height=5)
par(mfrow=c(1, 1))
for (i in 1:n_simulation){
...
## Residuals
pdf("train85_RF_residuals.pdf", width=10, height=4)
par(mfrow=c(1, 2))
...
pdf("train85_RF_coefs_samples.pdf", width=15, height=20)
par(mfrow=c(6, 3))
...
## Sigma2 of last iter
pdf("train85_RF_sigma2_samples.pdf", width=15, height=4)
par(mfrow=c(1, 3))
...
## ESS plots
pdf("train85_rfBLT_ess.pdf", width=7, height=5)
par(mfrow=c(1, 1))
for (i in 1:n_simulation){
...
## Residuals
pdf("train85_rfBLT_residuals.pdf", width=10, height=4)
par(mfrow=c(1, 2))
...
## Coefficients of last iter
pdf("train85_rfBLT_coefs_samples.pdf", width=15, height=20)
par(mfrow=c(6, 3))
...
## Sigma2 of last iter
pdf("train85_rfBLT_sigma2_samples.pdf", width=15, height=4)
par(mfrow=c(1, 3))
